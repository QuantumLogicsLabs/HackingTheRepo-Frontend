...
export default function SettingsPage() {
  ...
  const [showTokens, setShowTokens] = useState<TokenVisibility>({
    github: false,
    openai: false,
  });
    ...
    try {
      const payload = {
        ...
        githubToken: form.githubToken
          ? await encryptSecret(form.githubToken)
          : "",
        openaiKey: form.openaiKey ? await encryptSecret(form.openaiKey) : "",
      };
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-sub">
            Configure your GitHub token and OpenAI key for RepoMind.
          </p>
        </div>
      </div>
        ...
        <form onSubmit={handleSave} className="settings-form">
          ...
          <div className="settings-section card">
            ...
            <div className="settings-note">
              Your personal GitHub username helps with display. The actual PR
              bot uses the <code>SENDROOM</code> bot configured in the server
              environment.
            </div>
            <div className="settings-note">
              GitHub token and OpenAI key are encrypted client-side with AES-256
              before being sent to the backend for storage.
            </div>
            <div className="field">
            ...
            <div className="field">
              <label>
                ...
                {settings.hasGithubToken && (
                  <span className="token-saved">✓ saved</span>
                )}
              </label>
              <div className="token-field">
                ...
                <button
                  ...
                  className="show-btn"
                  onClick={() =>
                    setShowTokens((s) => ({ ...s, github: !s.github }))
                  }
                >
              ...
              <span className="field-hint">
                Needs <code>repo</code> scope. Used for verifying repository
                access in future features.
              </span>
            </div>
          </div>
          ...
          <div className="settings-section card">
            ...
            <div className="settings-note">
              The server uses the OpenAI key configured in{" "}
              <code>REPOMIND_API_URL</code>'s environment. You can optionally
              store your own key here for future per-user billing support.
            </div>
            <div className="field">
              <label>
                OpenAI API Key
              ...
              <div className="token-field">
                ...
                <button
                  ...
                  className="show-btn"
                  onClick={() =>
                    setShowTokens((s) => ({ ...s, openai: !s.openai }))
                  }
                >
        ...
        <div className="settings-side">
          <div className="card stats-mini">
            ...
            <div className="mini-stat">
              <div className="mini-stat-val" style={{ color: "var(--blue)" }}>
                {user?.totalJobs || 0}
              </div>
              <div className="mini-stat-label">Total Jobs</div>
            </div>
            <div className="mini-stat">
              <div className="mini-stat-val" style={{ color: "var(--accent)" }}>
                {user?.successfulPRs || 0}
              </div>
          ...
          <div className="card bot-status-card">
            <h3 className="settings-section-title" style={{ marginBottom: 12 }}>
              SENDROOM Bot
            </h3>
            ...
            <div className="settings-note" style={{ marginTop: 10 }}>
              The bot user is set in your server's{" "}
              <code>REPOMIND_GITHUB_TOKEN</code> and{" "}
              <code>REPOMIND_GITHUB_USERNAME</code> env vars. It creates PRs for
              all users.
            </div>
          </div>
        </div>
